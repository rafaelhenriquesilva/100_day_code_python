...
# Day 4 - HangMan Project
"""
    1 - Random the word
    2 - User say one letter
     - If contains, put on word in correct index
     - If not contains, put one error
    3 - Finish the word, You Win
    4 - If you do the max errors, you lose
"""
import hangman
import random
...
word_list = hangman.words
errors_list = hangman.errors_list
